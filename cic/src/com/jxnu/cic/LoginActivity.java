				...
				public void handleMessage(Message msg){
					if(msg.what==0x11){
						...
						if(returnData==null){
							...
							spEditor.putString("uname", returnData.getUsername());
							spEditor.putString("upwd", returnData.getPassword());
			...
			public void requestInternet(final userlogin transferUserlogin){
				...
				new Thread(){
					public void run() {
						...
						String returnJSONData = HttpCommon.HttpInternet(ConstApp.HttpServerUrl+"/UserLoginCheckForAndroid", strJson);
