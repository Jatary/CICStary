...
import com.jxnu.cic.adapter.Bean;
import com.jxnu.cic.adapter.SearchAdapter;
import com.jxnu.cic.adapter.SearchView;
...
public class SearchActivity extends Activity implements SearchView.SearchViewListener {
    ...
    private void getDbData() {
        ...
        for (int i = 0; i < size; i++) {
            dbData.add(new Bean(R.drawable.icon, "CET-4考试必过" + (i + 1), "CET-4自定义view——自定义搜索view", i * 20 + 2 + ""));
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
			...
			resultAdapter =new SearchAdapter(this,resultData,R.layout.item_bean_list);
            		//new SearchAdapter(this, resultData, R.layout.item_bean_list);
        } else {
    ...
    public void onSearch(String text) {
        ...
        Toast.makeText(this, "搜素完成", Toast.LENGTH_SHORT).show();
